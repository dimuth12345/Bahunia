...
<body>
  ...
  if (isset($_POST['register'])) {
    ...
    $sql = "INSERT INTO features_product( p_name, p_featured_photo,  p_old_price, p_new_price, p_qty,p_description,p_condition, p_return_policy  ) VALUES (' $p_name', '$p_featured_photo', '$p_old_price', ' $p_new_price',  ' $p_qty', ' $p_description', '$p_condition',' $p_return_policy')";
