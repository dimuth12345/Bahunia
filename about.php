        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card">
              <div class="card-body">
                <h2>About Us</h2>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed eu diam vel urna euismod fringilla. Vestibulum condimentum feugiat nunc, eget ullamcorper mauris ullamcorper et.</p>
              </div>
            </div>
          </div>
          <div class="col-md-6">
