...
<body>
    ...
    <div class="container-fluid p-0">
        ...
        <div class="bg-light mb-4">
            <h3 class ="text-center mb-2">Men's Collection</h3>
...
<body>
  ...
  <div class="slider">
    <img src="a.png" alt="Slider Image 1">
    <img src="b.png" alt="Slider Image 2">
    <img src="c.png" alt="Slider Image 3">
    <img src="d.png" alt="Slider Image 2">
    <img src="man.png" alt="Slider Image 3">
  </div>
</div>
<style>
  .slider-container {
            ...
            <div class="container-fluid my-5 bg-light">
                ...
                <div class="row mt-5">
                    <div class="owl-carousel owl-theme">
                        ...
                        $query = "SELECT * FROM mens_collection";
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            <div class="card m-2" style="width: 18rem">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="cartview.php?id='.$p_id.'&catagory=mc" class="btn btn-primary">View</a>
                                </div>
                            </div>
                                ';
                            }
