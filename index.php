  ...
  startSlider();
        ...
        <section>
            <div class="container-fluid my-5 bg-light">
                <h1 class="text-center fw-bold display-10 mb-3">Discover our newest additions to the product lineup.</h1>
                <h5 class="text-center display-6 mb-3 ">Explore our updated collection of newly added products.</h5>
                <div class="row mt-5">
