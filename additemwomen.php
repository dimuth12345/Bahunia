...
<html>
<head> 
  <title>Add Items to the Women Collection</title>
  <style>
    .container {
      width: 300px;
      margin: 0 auto;
...
<body>
  <div class="container">
    <h2>Add Items to the Women Collection </h2>
  ...
  if (isset($_POST['register'])) {
    ...
    $sql = "INSERT INTO womens_collection ( p_name, p_featured_photo,  p_old_price, p_new_price, p_qty,p_description,p_condition, p_return_policy  ) VALUES (' $p_name', '$p_featured_photo', '$p_old_price', ' $p_new_price',  ' $p_qty', ' $p_description', '$p_condition',' $p_return_policy')";
